	...
	public boolean keyDown(int keycode) 
	{
		switch(keycode)
		{
			...
			case Keys.LEFT:
				...
				break;
			case Keys.SPACE:
					if(this.screen.getExplorer().getState() == this.screen.getExplorer().getWalkLeft()){
						this.screen.getExplorer().setState(this.screen.getExplorer().getJumpLeft());
					}
					else if
					(this.screen.getExplorer().getState() == this.screen.getExplorer().getWalkRight()){
						this.screen.getExplorer().setState(this.screen.getExplorer().getJumpRight());
					}
