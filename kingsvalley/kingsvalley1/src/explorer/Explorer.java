...
public class Explorer {
	...
	private ExplorerIdleJumpRight jumpIdleRight;
	private ExplorerIdleJumpLeft jumpIdleLeft;

	public ExplorerIdleJumpRight getJumpIdleRight() {
		return jumpIdleRight;
	}
	public void setJumpIdleRight(ExplorerIdleJumpRight jumpIdleRight) {
		this.jumpIdleRight = jumpIdleRight;
	}
	public ExplorerIdleJumpLeft getJumpIdleLeft() {
		return jumpIdleLeft;
	}
	public void setJumpIdleLeft(ExplorerIdleJumpLeft jumpIdleLeft) {
	...
	public Explorer(KingsValley game, Vector2 position, float speed)
	{
		...
		this.jumpIdleRight = new ExplorerIdleJumpRight(this,20,32);
		this.jumpIdleLeft = new ExplorerIdleJumpLeft(this,-20,32);
